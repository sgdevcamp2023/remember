...
//   const { categories, registerCategories, removeCategories } =
//     CategoriesStore();
...
//     };
//     axios
//       .post(apiAddr + "/api/community/registration/category", data, {
//         headers: {
...
//     };
//     axios
//       .post(apiAddr + "/api/community/registration/category/channel", data, {
//         headers: {
//           Authorization: bearerToken,
//         },
//       })
...
//           <h2
//             onClick={() => toggleCategory(category.categoryReadId)}
//             onContextMenu={(e) => handleCategoryId(e, category.categoryReadId)}
//           >
//             {collapsedCategories.includes(category.categoryReadId) ? ">" : "v"}{" "}
//             {category.name}
//           </h2>
//           {!collapsedCategories.includes(category.categoryReadId) &&
//             channels
//               .filter(
//                 (channel) => channel.categoryId === category.categoryReadId
//               )
//               .map((channel) => (
//                 <div
