...
public class UserJpaEntity extends AggregateRoot<UserJpaEntity, UserIdJpaVO> {
    ...
    @Builder
    public UserJpaEntity(UserIdJpaVO userId, String email, String nickname, String profile) {
        this.userId = userId;
